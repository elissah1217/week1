...
class SettingsViewController2: UIViewController {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue!, sender: AnyObject!) {
        ...
        let navVC = segue.destinationViewController as SignInNavigationController
        let signInVC = navVC.topViewController as SignInRootViewController
        // let tableVC = navVC.viewControllers.first as YourTableViewControllerClass
        
        signInVC.didSignOut = true
